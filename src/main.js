...
//    parser.parseURL(rss_NU, function(err, feed) {
	...
	archiveArray.push(newsArray);
	console.log(`Archive array ${archiveArray[0]}`);
	if ( newsArray !== archiveArray){
		app.set({ NuNLArchivedNews: archiveArray});
		console.log('archiveArray has been set!!!');
